      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500">Manage contacts and addresses</p>
          </div>
        </div>
        <button
          onClick={() => openModal()}
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${typeColors[addr.type] || typeColors.other}`}>
                        <TypeIcon className="w-5 h-5" />
                      </div>
                      <div>
                        <p className="font-semibold text-gray-900">{addr.name}</p>
                        <div className="flex items-center gap-3 mt-1">
                          <span className={`px-2 py-0.5 rounded-full text-xs font-medium capitalize ${typeColors[addr.type] || typeColors.other}`}>
                            {addr.type}
                          </span>
                          {addr.phone && (
                        ...
                        {addr.notes && (
                          <p className="text-sm text-gray-400 mt-1">{addr.notes}</p>
                        )}
                      </div>
                    </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div 
            ...
            onClick={closeModal}
          />
          <div className="relative w-full max-w-md p-6 rounded-lg bg-white shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 rounded-lg bg-white border border-gray-300 text-gray-900 placeholder-gray-400"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2.5 rounded-lg bg-white border border-gray-300 text-gray-900 placeholder-gray-400 resize-none"
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2.5 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
                >
                  <Check size={18} />
